...
BEGIN_MESSAGE_MAP(CMFCCACLUIDlg, CDialogEx)
	...
	ON_BN_CLICKED(IDC_BUTTON_Rad, &CMFCCACLUIDlg::OnBnClickedButtonRad)
	ON_BN_CLICKED(IDC_BUTTON_Deg, &CMFCCACLUIDlg::OnBnClickedButtonDeg)
END_MESSAGE_MAP()
...
void CMFCCACLUIDlg::SaveFirstValue()
{
	UpdateData(TRUE);
...
void CMFCCACLUIDlg::OnBnClickedButtonRad()
{
	// TODO: 在此添加控件通知处理程序代码
	SaveFirstValue();
	mMode = 0;
...
void CMFCCACLUIDlg::OnBnClickedButtonDeg()
{
	// TODO: 在此添加控件通知处理程序代码
	SaveFirstValue();
	mMode = 1;
